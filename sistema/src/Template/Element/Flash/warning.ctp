...
<div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="true" data-delay="5000" style="padding-top:0;position: absolute; top: 61px; right: 0; z-index:1000; ">
    <div class="toast-header" style="background-color:#f7b924;border:0">
        <strong class="mr-auto" style="background-color:#f7b924;color:white;font-weight: bold">Alerta</strong>
        <small></small>
    ...
    <div class="toast-body" style="background-color:#f7b924;color:white;">
        <?= $message ?>
    </div>
</div>
