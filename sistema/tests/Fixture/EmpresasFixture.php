...
class EmpresasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'inscricao' => ['type' => 'string', 'length' => 63, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'telefone' => ['type' => 'string', 'length' => 63, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'email' => ['type' => 'string', 'length' => 125, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'u_id' => ['type' => 'index', 'columns' => ['u_id'], 'length' => []],
            'endereco_id' => ['type' => 'index', 'columns' => ['endereco_id'], 'length' => []],
            'representante_id' => ['type' => 'index', 'columns' => ['representante_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'data_fim' => '2019-10-08',
                'created' => '2019-10-08 12:20:50',
                'modified' => '2019-10-08 12:20:50',
                'mensal' => 1.5,
