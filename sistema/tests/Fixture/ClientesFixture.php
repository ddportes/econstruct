...
class ClientesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cliente_situacao_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'cliente_situacao_id' => ['type' => 'index', 'columns' => ['cliente_situacao_id'], 'length' => []],
