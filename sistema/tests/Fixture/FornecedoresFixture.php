...
class FornecedoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'fornecedor_situacao_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'fornecedor_situacao_id' => ['type' => 'index', 'columns' => ['fornecedor_situacao_id'], 'length' => []],
