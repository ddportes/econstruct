...
class OcorrenciasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ocorrencia_tipo_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'ocorrencia_tipo_id' => ['type' => 'index', 'columns' => ['ocorrencia_tipo_id'], 'length' => []],
